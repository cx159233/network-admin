  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device !== 'mobile'">
        ...
        <el-tooltip
          :content="$t('Component.Layout.Navbar.FullScreen')"
          effect="dark"
          placement="bottom"
        >
        ...
        <el-tooltip
          :content="$t('Component.Layout.Navbar.LayoutSize')"
          effect="dark"
          placement="bottom"
        >
        ...
        <!-- <el-tooltip
          :content="$t('Component.Layout.Navbar.Language')"
          effect="dark"
          placement="bottom"
        >
          <language-select
      ...
      >
        <div class="avatar-wrapper">
          <el-image :src="avatar" class="user-avatar">
            <div slot="error" class="image-slot">
              <img
                src="@/assets/images/default_banner_avatar.png"
                class="user-avatar"
              />
            </div>
          </el-image>
        ...
        <el-dropdown-menu slot="dropdown">
          <router-link to="/user/profile">
            <el-dropdown-item>{{
              $t("Router.AccountCenter")
            }}</el-dropdown-item>
          </router-link>
          <router-link to="/user/preference">
            <el-dropdown-item>{{
              $t("Router.UserPreference")
            }}</el-dropdown-item>
          </router-link>
...
export default {
  ...
  methods: {
    ...
    async logout() {
      this.$confirm(
        this.$t("Component.Layout.Navbar.ConfirmLogoutTip"),
