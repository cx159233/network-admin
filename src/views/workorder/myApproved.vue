...
export default {
  ...
  methods: {
      ...
      setTimeout(() => {
        this.workorderList = [
          ...
          },
          {
            ...
            finishTime: '2026-03-31 15:00:00',
            applicant: '赵六',
            handler: '当前用户'
          },
          {
            ...
            finishTime: '2026-03-25 11:30:00',
            applicant: '钱八',
            handler: '当前用户'
          },
          {
            ...
            finishTime: '2026-03-20 16:00:00',
            applicant: '周九',
            handler: '当前用户'
          },
          {
            ...
            finishTime: '2026-03-15 14:00:00',
            applicant: '吴十',
            handler: '当前用户'
          }
        ];
    ...
    handleWorkorderClick(workorder) {
      ...
      this.$router.push({
        path: '/workorder/myBills/myApprovedDetail',
