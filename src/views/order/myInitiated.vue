...
export default {
  ...
  data() {
    return {
      ...
      orderList: [
        { orderNo: '202608100089', serviceId: 'SVC-0234', serviceName: '智慧园区综合管理平台', serviceProvider: '北京健康科技有限公司', serviceSpec: '标准版，含500个设备接入 + 数据看板', orgName: '北京市海淀区数字经济发展局', applicant: '张三', department: '技术部', serviceType: '数字应用', status: '已完成', workorderId: 'TK-0234', applyTime: '2026-03-15 14:32' },
        ...
        { orderNo: '202608100091', serviceId: 'SVC-0236', serviceName: '数据可视化分析平台', serviceProvider: '东华软件', serviceSpec: '企业版，含20个数据源接入 + 大屏展示', orgName: '北京市海淀区数字经济发展局', applicant: '张三', department: '技术部', serviceType: '数字应用', status: '已完成', workorderId: 'TK-0236', applyTime: '2026-03-05 16:45' },
        { orderNo: '202608100088', serviceId: 'SVC-0230', serviceName: '消息推送中间件', serviceProvider: '腾讯云', serviceSpec: '支持短信/邮件/站内信多通道，100万条/月', orgName: '北京市海淀区数字经济发展局', applicant: '张三', department: '技术部', serviceType: '能力组件', status: '已评价', workorderId: 'TK-0230', applyTime: '2026-02-20 10:00' },
