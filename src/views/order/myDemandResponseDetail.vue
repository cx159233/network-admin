<template>
  <div class="demand-detail-page">
    <PageHeader
      :title="`响应详情 · ${demandInfo.demandNo}`"
      description="查看本机构对需求的响应详情，包括响应内容和报价信息"
    >
      <template #actions>
...
export default {
  ...
  data() {
    return {
      demandInfo: {
        demandNo: 'DM-20260810-0007',
        demandDescription: '需要采购高性能GPU计算集群，用于AI模型训练',
        serviceType: '基础服务',
        orgName: '北京人工智能研究院',
        applicant: '王五',
        status: '已响应',
        publishTime: '2026-03-12 08:30:00',
        ...
        responseTime: '2026-03-13 09:20:00'
      }
    }
  },
  methods: {
