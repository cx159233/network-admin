          ...
          <el-row :gutter="10">
            ...
            <el-col :span="1.5">
              <el-button
                ...
                icon="el-icon-unlock"
                v-hasPermi="[$p('Catalog:EditContent:{0}', [catalogId])]"
                @click="handleChangeLockState"
                >{{ $t("CMS.Content.Unlock") }}</el-button
              >
              <el-button
                plain
                type="primary"
            ...
            <el-col :span="1.5">
              <el-button
                ...
                size="mini"
                icon="el-icon-share"
                @click="handleRelaContent"
                >{{ $t("CMS.Content.RelaContent") }}</el-button
              >
            </el-col>
            <el-col :span="1.5">
              <el-button
                ...
                icon="el-icon-files"
                v-hasPermi="[$p('Catalog:EditContent:{0}', [catalogId])]"
                @click="handlePushToBaidu"
                >{{ $t("CMS.Content.PushToBaidu") }}</el-button
              >
            </el-col>
            <el-col :span="1.5">
              <el-popover
    ...
    <el-row class="art-editor-container" :gutter="10" v-loading="loading">
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        <el-col :span="16">
          ...
          <el-row
            v-if="this.form.linkFlag !== 'Y' && this.contentType === 'article'"
          >
            <el-col class="pr10">
                  ...
                  <el-col :span="12">
                    ...
                    >
                      ...
                      <span style="color: #909399; font-size: 12px"
                        ><i class="el-icon-info mr5 ml10"></i
                        >{{ $t("CMS.Content.DownloadImageTip") }}</span
                      >
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item style="text-align: right">
                      <el-tooltip
                        class="item"
                        effect="dark"
                        :content="$t('CMS.Content.ImportCSSTip')"
                        placement="top"
                      >
                        <i
                          class="el-icon-info"
                          style="color: #909399; margin-right: 16px"
                        />
                      </el-tooltip>
                      <el-select
                        v-model="ueditorImportCss"
          ...
          <el-row
            v-if="this.form.linkFlag !== 'Y' && this.contentType === 'image'"
          >
            <el-col class="pr10">
              <cms-image-editor
                v-model="form.imageList"
                @choose="handleSetLogo"
              ></cms-image-editor>
            </el-col>
          </el-row>
          <el-row
            v-if="this.form.linkFlag !== 'Y' && this.contentType === 'audio'"
          >
            <el-col class="pr10">
              <cms-audio-editor
          ...
          <el-row
            v-if="this.form.linkFlag !== 'Y' && this.contentType === 'video'"
          >
            <el-col class="pr10">
              <cms-video-editor
            ...
            <el-card shadow="always">
              <el-tabs v-model="activeName" @tab-click="handleTabClick">
                <el-tab-pane :label="$t('CMS.Content.Basic')" name="basic">
                  ...
                  >
                    <el-button-group>
                      <el-button
                        ...
                        style="width: 152px"
                        disabled
                        >{{ form.catalogName }}</el-button
                      >
                      <el-button
                        type="primary"
                        icon="el-icon-edit"
                        @click="handleCatalogChange"
                      ></el-button>
                    </el-button-group>
                  </el-form-item>
                  ...
                  <el-form-item
                    :label="$t('CMS.Content.PublishDate')"
                    prop="publishDate"
                  >
                    <el-date-picker
                  ...
                  <el-form-item
                    :label="$t('CMS.Content.OfflineDate')"
                    prop="offlineDate"
                  >
                    <el-date-picker
                ...
                >
                  <el-divider content-position="left">{{
                    $t("CMS.Content.SEOConfig")
                  }}</el-divider>
                  <el-form-item
                    :label="$t('CMS.ContentCore.SEOTitle')"
                    prop="seoTitle"
                  >
                    <el-input v-model="form.seoTitle" />
                  </el-form-item>
                  <el-form-item
                    :label="$t('CMS.ContentCore.SEOKeyword')"
                    prop="seoKeywords"
                  >
                    <el-input v-model="form.seoKeywords" />
                  </el-form-item>
                  <el-form-item
                    :label="$t('CMS.ContentCore.SEODescription')"
                    prop="seoDescription"
                  >
                    <el-input v-model="form.seoDescription" />
                  </el-form-item>
                  <el-divider content-position="left">{{
                    $t("CMS.Content.ExtendTemplate")
                  }}</el-divider>
                  <el-form-item
                    v-for="pp in publishPipeProps"
                    :label="pp.pipeName"
                  ...
                  >
                    <el-input v-model="pp.props.contentExTemplate">
                      <el-button
                        slot="append"
                        icon="el-icon-folder-opened"
                        @click="handleSelectTemplate(pp, true)"
                      ></el-button>
                    </el-input>
                  </el-form-item>
                </el-tab-pane>
  ...
  methods: {
    ...
    onEditorReady(editor) {
      ...
      editor.plugins.get("FileRepository").createUploadAdapter = (loader) => {
        return new ImageUploadAdapter(
          loader,
          process.env.VUE_APP_BASE_API + "/cms/resource/upload"
        );
      };
    },
    initData() {
    ...
    handleClose() {
      ...
      if (this.isFormChanged()) {
        this.$confirm(
          this.$t("CMS.Content.CloseContentEditorTip"),
