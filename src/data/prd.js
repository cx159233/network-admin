...
<tr><td>审核状态</td><td></td><td>取自末尾阶段审核状态，枚举：已通过、已驳回、审核中、未开始</td></tr>
...
<tr><td>审核状态</td><td></td><td>枚举：已通过（绿色）、已驳回（红色）、审核中（蓝色）、未开始（灰色）</td></tr>
...
<p>4、操作-导出清单</p>
<p>列表页提供【导出清单-按钮】，点击后导出当前筛选条件下的订单数据。</p>

<h3 id="prd-3.1.2.1.2">3.1.2.1.2 服务订阅详情</h3>
<p><strong>模块描述：</strong>服务管理 / 开通管理 / 服务订阅 / 详情</p>
<p><strong>功能描述：</strong>以右侧抽屉形式展示订单完整信息，包括基本信息、流程进度和关联工单，支持对已完成订单新增满意度评价。</p>
<p><strong>优先级：</strong>P1</p>
...
<tr><td>评价描述</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>评价时间</td><td></td><td>格式：yyyy-MM-dd hh:mm:ss，为空时显示"--"</td></tr>
</table>
<p>5、操作-新增满意度评价</p>
...
<p><strong>优先级：</strong>P1</p>
<p><strong>输入/前置条件：</strong>进入页面自动加载订单记录。</p>
<p><strong>详细设计：</strong></p>
<p>1、筛选区域</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<p><strong>功能描述：</strong>以右侧抽屉形式展示订单完整信息，包括基本信息、流程进度和关联工单，支持查看评价和回复评价。</p>
<p><strong>优先级：</strong>P1</p>
...
<p>4、评价与回复</p>
<p>当订单状态为已评价时，可查看评价详情和开发者回复。开发者可通过【回复】按钮对评价进行回复。</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<p>b.若网络异常/超时/宕机，进行消息提示，停留当前页面</p>
<p style="font-style:italic; color:#999">Tip：异常处理提示文案开发人员自行定义</p>
<p>c.若满足条件，保存回复内容，关闭弹窗，进行消息提示，刷新页面</p>
<p style="font-style:italic; color:#999">Tip：回复成功</p>
<p>2）操作-取消</p>
<p>点击【取消-按钮】，关闭弹窗，不保存回复内容，停留当前页面。</p>
<p>5、操作-返回列表</p>
<p>关闭右侧抽屉，返回开通记录列表页。</p>

<h3 id="prd-3.1.2.3">3.1.2.3 评价与回复</h3>
<p><strong>模块描述：</strong>开通管理 / 评价与回复</p>
<p><strong>功能描述：</strong>机构用户对已完成订单进行满意度评价；开发者对已评价订单进行回复。</p>
<p><strong>优先级：</strong>P1</p>
<p><strong>详细设计：</strong></p>
<p>1、服务评价（机构用户）</p>
<p>仅当订单状态为已完成时，操作栏显示【评价-按钮】，点击打开评价弹窗。</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<p><strong>页面描述：</strong>管理本机构发起的需求，支持新增、查看详情和关闭操作。</p>

<h3 id="prd-3.1.3.1.1">3.1.3.1.1 需求发起列表</h3>
<p><strong>模块描述：</strong>服务管理 / 需求管理 / 需求发起 / 列表</p>
<p><strong>功能描述：</strong>展示本机构发起的需求列表，支持按需求编号、机构名称、服务类型和状态筛选。</p>
<p><strong>优先级：</strong>P1</p>
...
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>数字应用名称</td><td>name</td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
...
<p>1）若网络异常/超时/宕机，关闭此对话框，停留当前页面，进行消息提示</p>
<p style="font-style:italic; color:#999">Tip：异常处理提示文案开发人员自行定义</p>
<p>2）若满足条件，状态变更为已下架，关闭此对话框，进行消息提示，刷新列表</p>
...
<h3 id="prd-3.2.1.2">3.2.1.2 能力组件管理</h3>
<p><strong>入口页面：</strong>运营管理后台 / 服务目录管理 / 能力组件管理</p>
<p><strong>页面描述：</strong>管理平台能力组件的上架与全生命周期，支持发布、下线及删除等操作。</p>

<h3 id="prd-3.2.1.2.1">3.2.1.2.1 能力组件列表</h3>
<p><strong>模块描述：</strong>运营管理后台 / 服务目录管理 / 能力组件管理</p>
<p><strong>功能描述：</strong>展示平台能力组件列表，支持按组件名称、组件ID、服务商名称、部署云服务商、开放范围和状态筛选，可进行新增、修改、删除、发布、下线操作。</p>
<p><strong>优先级：</strong>P1</p>
...
<h3 id="prd-3.2.1.2.2">3.2.1.2.2 新增能力组件</h3>
...
<h3 id="prd-3.2.1.2.3">3.2.1.2.3 编辑能力组件</h3>
...
<h3 id="prd-3.2.1.2.4">3.2.1.2.4 能力组件详情</h3>
...
<h3 id="prd-3.2.1.2.7">3.2.1.2.7 删除能力组件</h3>
...
<h3 id="prd-3.2.1.3.1">3.2.1.3.1 基础服务列表</h3>
...
<h3 id="prd-3.2.1.3.2">3.2.1.3.2 新增基础服务</h3>
...
<h3 id="prd-3.2.1.3.3">3.2.1.3.3 编辑基础服务</h3>
...
<h3 id="prd-3.2.1.3.4">3.2.1.3.4 基础服务详情</h3>
...
<h3 id="prd-3.2.1.3.7">3.2.1.3.7 删除基础服务</h3>
...
<h3 id="prd-3.2.1.4.1">3.2.1.4.1 安全服务列表</h3>
...
<h3 id="prd-3.2.1.4.3">3.2.1.4.3 编辑安全服务</h3>
...
<h3 id="prd-3.2.1.4.4">3.2.1.4.4 安全服务详情</h3>
...
<tr><td>审核状态</td><td></td><td>取自末尾阶段审核状态，枚举：已通过、已驳回、审核中</td></tr>
<tr><td>审核人</td><td></td><td>取自末尾阶段审核人，完整展示，为空时显示"--"</td></tr>
<tr><td>审核时间</td><td></td><td>取自末尾阶段审核时间，格式：yyyy-MM-dd hh:mm:ss</td></tr>
<tr><td>审核意见</td><td></td><td>取自末尾阶段审核意见，完整展示，为空时显示"--"</td></tr>
</table>
...
<h3 id="prd-3.2.1.4.7">3.2.1.4.7 删除安全服务</h3>
...
<h3 id="prd-3.2.2.1.1">3.2.2.1.1 机构资质审核列表</h3>
<p><strong>模块描述：</strong>服务审核管理 / 机构资质审核 / 机构资质审核列表</p>
...
<h3 id="prd-3.2.2.1.2">3.2.2.1.2 审核详情抽屉</h3>
<p><strong>模块描述：</strong>服务审核管理 / 机构资质审核 / 审核详情抽屉</p>
<p><strong>功能描述：</strong>以右侧抽屉形式查看机构入驻申请的详细资质信息，进行审核通过或驳回操作。抽屉宽度1100px，左右分栏布局：左侧展示机构资质详情，右侧展示审核操作区。</p>
<p><strong>优先级：</strong>P1</p>
<p><strong>输入/前置条件：</strong>点击列表【审核-按钮】（待审核状态）或【详情-按钮】（已通过/已驳回状态）打开详情抽屉。</p>
<p><strong>详细设计：</strong></p>
<p>1、左侧-企业基本情况</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<p>5、右侧-审核操作</p>
<p>1）待审核状态：显示审核意见输入框（多行文本，最多200字，显示字数统计，占位提示"请输入审核意见"）、【审核通过-按钮】和【驳回-按钮】。</p>
<p>2）已审核状态：显示审核结果记录（审核意见 + 审核人 + 审核时间）。</p>
<p>6、操作-审核通过</p>
...
<h3 id="prd-3.2.2.2.1">3.2.2.2.1 数字应用审核列表</h3>
<p><strong>模块描述：</strong>服务审核管理 / 数字应用审核 / 数字应用审核列表</p>
<p><strong>功能描述：</strong>展示数字应用审核列表，支持按提交时间、审核状态、审核阶段、应用名称、应用ID、服务商名称、应用覆盖范围和面向对象筛选，可进行审核和查看详情操作。</p>
<p><strong>优先级：</strong>P1</p>
<p><strong>输入/前置条件：</strong>进入页面自动加载审核列表。</p>
<p><strong>详细设计：</strong></p>
<p>1、筛选区域</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>提交时间</td><td></td><td>日期范围选择器，占位提示"提交时间"，格式yyyy-MM-dd</td></tr>
<tr><td>审核状态</td><td></td><td>枚举：待审核、已通过、已拒绝，默认不选中</td></tr>
<tr><td>审核阶段</td><td></td><td>枚举：申报材料评估、应用技术测评、现场演示答辩、服务目录发布，默认不选中</td></tr>
<tr><td>数字应用名称</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>数字应用ID</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>服务商名称</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>应用覆盖范围</td><td></td><td>枚举：基本公共卫生服务、医院信息系统（HIS）、家庭医生签约、实验室信息管理系统（LIS）、影像归档和通信系统（PACS），默认不选中</td></tr>
<tr><td>面向对象</td><td></td><td>枚举：基层医疗卫生机构、公立医院、医技护人员，默认不选中</td></tr>
<tr><td>查询按钮</td><td></td><td>点击后以筛选条件为入参，刷新列表，响应对应内容</td></tr>
<tr><td>重置按钮</td><td></td><td>点击后清空搜索框，重置列表为全部数据</td></tr>
</table>
<p>2、列表展示</p>
<p>1）数据范围为所有机构（不区分机构）提交的审核状态为待审核、已通过、已拒绝的数字应用审核数据。</p>
<p>2）根据筛选查询条件，刷新列表并根据入参响应对应内容，按提交时间倒序排列。</p>
<p>3）默认加载10条最新数据，通过分页形式分隔长列表，可调整每页加载条数。</p>
<p>4）当前列表数据为空时，显示"暂无数据"。</p>
<p>5）支持列设置，可自定义显示/隐藏列。</p>
...
<tr><td>数字应用名称/ID</td><td></td><td>上方展示应用名称，下方展示应用ID（小号字体），为空时显示"--"</td></tr>
<tr><td>面向对象</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>应用覆盖范围</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>服务商名称</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>合作企业</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>部署云服务商</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
</table>
<p>3、状态流转与按钮</p>
<table>
...
<h3 id="prd-3.2.2.2.2">3.2.2.2.2 审核详情抽屉</h3>
<p><strong>模块描述：</strong>服务审核管理 / 数字应用审核 / 审核详情抽屉</p>
<p><strong>功能描述：</strong>以右侧抽屉形式查看数字应用备案的详细信息，进行多阶段审核操作。抽屉宽度1100px，左右分栏布局：左侧展示应用概览信息，右侧展示四阶段审核流程。</p>
<p><strong>优先级：</strong>P1</p>
<p><strong>输入/前置条件：</strong>点击列表【审核-按钮】（待审核状态）或【详情-按钮】（已通过/已拒绝状态）打开详情抽屉。</p>
<p><strong>详细设计：</strong></p>
<p>1、抽屉头部</p>
<p>展示应用LOGO（无LOGO时显示默认图标）、应用名称、审核状态标签、应用ID。</p>
<p>2、左侧-基本信息</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>系统地址</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>显示顺序</td><td></td><td>数字展示，为空时显示0</td></tr>
<tr><td>应用描述</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
</table>
<p>3、左侧-联系信息</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>服务商名称</td><td></td><td>完整展示，为空时显示"--"</td></tr>
<tr><td>合作伙伴</td><td></td><td>完整展示，为空时显示"--"</td></tr>
<tr><td>联系方式1</td><td></td><td>展示联系人姓名和电话，为空时显示"--"</td></tr>
<tr><td>联系方式2</td><td></td><td>展示联系人姓名和电话，为空时显示"--"</td></tr>
</table>
<p>4、左侧-分类标签</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>面向对象</td><td></td><td>完整展示，为空时显示"--"</td></tr>
<tr><td>应用架构</td><td></td><td>完整展示，为空时显示"--"</td></tr>
...
<h3 id="prd-3.2.2.3">3.2.2.3 能力组件审核</h3>
<p><strong>入口页面：</strong>运营管理后台 / 服务审核管理 / 能力组件审核</p>
<p><strong>页面描述：</strong>审核机构提交的能力组件上架申请，支持四阶段审核与通过或驳回操作。</p>

<h3 id="prd-3.2.2.3.1">3.2.2.3.1 能力组件审核列表</h3>
<p><strong>模块描述：</strong>服务审核管理 / 能力组件审核 / 能力组件审核列表</p>
...
<tr><td>组件ID</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>服务商名称</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>部署云服务商</td><td></td><td>枚举：电信云、移动云、联通云、浪潮云、紫光云、影像云，默认不筛选</td></tr>
<tr><td>开放范围</td><td></td><td>枚举：不限、市级、区（县）域，默认不筛选</td></tr>
<tr><td>列设置按钮</td><td></td><td>点击可自定义显示/隐藏列表列</td></tr>
<tr><td>查询按钮</td><td></td><td>点击后以筛选条件为入参，刷新列表，响应对应内容</td></tr>
<tr><td>重置按钮</td><td></td><td>点击后清空搜索框，重置列表为全部数据</td></tr>
</table>
<p>2、列表展示</p>
<p>1）数据范围为所有机构（不区分机构）提交的所有审核状态（待审核、已通过、已拒绝）的能力组件审核数据。</p>
...
<tr><td>能力组件名称/ID</td><td></td><td>上方展示组件名称（加粗），下方展示组件ID（灰色小字），为空时显示"--"</td></tr>
<tr><td>组件描述</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>服务商名称</td><td></td><td>超出1行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>部署云服务商</td><td></td><td>完整展示，为空时显示"--"</td></tr>
<tr><td>开放范围</td><td></td><td>枚举：不限、市级、区（县）域</td></tr>
</table>
<p>3、状态流转与按钮</p>
<pre style="background:#f5f7fa;padding:12px;border-radius:4px;font-size:13px;line-height:1.8;overflow-x:auto">
待审核 --(审核)---→ 审核通过 / 审核拒绝
...
<h3 id="prd-3.2.2.3.2">3.2.2.3.2 审核详情抽屉</h3>
<p><strong>模块描述：</strong>服务审核管理 / 能力组件审核 / 审核详情抽屉</p>
<p><strong>功能描述：</strong>查看能力组件备案的详细信息，进行四阶段审核操作。抽屉宽度1100px，左右分栏布局。</p>
<p><strong>优先级：</strong>P1</p>
...
<tr><td>组件名称</td><td></td><td>加粗大号字体展示</td></tr>
<tr><td>审核状态</td><td></td><td>使用StatusDot组件展示当前审核状态</td></tr>
<tr><td>组件ID</td><td></td><td>灰色小字，格式"ID：XXX"</td></tr>
</table>
<p>2、左侧——基本信息</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>显示顺序</td><td></td><td>数字，默认为0</td></tr>
<tr><td>组件描述</td><td></td><td>多行文本展示，为空时显示"--"</td></tr>
</table>
<p>3、左侧——联系信息</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>服务商名称</td><td></td><td>完整展示，为空时显示"--"</td></tr>
<tr><td>联系方式1</td><td></td><td>展示联系人姓名+电话，格式"姓名 电话"，为空时显示"--"</td></tr>
<tr><td>联系方式2</td><td></td><td>展示联系人姓名+电话，格式"姓名 电话"，为空时显示"--"</td></tr>
</table>
<p>4、左侧——分类标签</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<h3 id="prd-3.2.2.4">3.2.2.4 基础服务审核</h3>
<p><strong>入口页面：</strong>运营管理后台 / 服务审核管理 / 基础服务审核</p>
<p><strong>页面描述：</strong>审核云服务商提交的基础服务上架申请，支持四阶段审核与通过或驳回操作。</p>

<h3 id="prd-3.2.2.4.1">3.2.2.4.1 基础服务审核列表</h3>
<p><strong>模块描述：</strong>服务审核管理 / 基础服务审核 / 基础服务审核列表</p>
...
<p>2、列表展示</p>
<p>1）数据范围为所有云服务商（不区分机构）提交的所有审核状态（待审核、已通过、已拒绝）的基础服务审核数据。</p>
<p>2）根据筛选查询条件，刷新列表并根据入参响应对应内容，默认按提交时间倒序排列，待审核数据优先展示。</p>
<p>3）默认加载10条最新数据，通过分页形式分隔长列表，可调整每页加载条数。</p>
<p>4）当前列表数据为空时，显示"暂无数据"。</p>
<p>5）支持列设置，可自定义显示/隐藏列。</p>
...
<h3 id="prd-3.2.2.4.2">3.2.2.4.2 审核详情抽屉</h3>
<p><strong>模块描述：</strong>服务审核管理 / 基础服务审核 / 审核详情抽屉</p>
<p><strong>功能描述：</strong>查看基础服务备案的详细信息，进行四阶段审核操作。抽屉宽度1100px，左右分栏布局。</p>
<p><strong>优先级：</strong>P1</p>
<p><strong>输入/前置条件：</strong>点击列表【审核-按钮】或【详情-按钮】打开详情抽屉。</p>
<p><strong>详细设计：</strong></p>
<p>1、抽屉头部</p>
...
<p style="font-style:italic; color:#999">Tip：审核通过，服务已上架</p>
<p>7、操作-驳回</p>
<p>点击【驳回-按钮】，判断逻辑如下：</p>
<p>1）若审核意见为空，进行表单校验提示</p>
<p style="font-style:italic; color:#999">Tip：请填写驳回原因</p>
...
<p><strong>页面描述：</strong>管理平台所有服务订单，支持查看订单详情、取消订单、查看评价及导出清单。</p>

<h3 id="prd-3.2.3.1.1">3.2.3.1.1 订单列表</h3>
<p><strong>模块描述：</strong>服务开通管理 / 服务开通列表</p>
<p><strong>功能描述：</strong>展示平台全部订单列表，支持按服务单号、服务名称、服务ID、服务商名称、申请机构、服务类型和状态筛选，支持导出清单，可按状态执行详情、取消、查看评价等操作。</p>
<p><strong>优先级：</strong>P1</p>
...
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>导出清单按钮</td><td></td><td>点击后导出当前筛选条件下的订单数据为清单文件</td></tr>
<tr><td>服务单号</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>服务名称</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>服务ID</td><td></td><td>支持模糊搜索</td></tr>
<tr><td>服务商名称</td><td></td><td>支持模糊搜索</td></tr>
...
<p>4、操作-取消订单</p>
<p>仅工单流转中状态可操作，点击【取消-按钮】弹出确认对话框，确认后订单状态变更为已取消。</p>

<h3 id="prd-3.2.3.2">3.2.3.2 订单详情</h3>
<p><strong>模块描述：</strong>服务开通管理 / 服务开通列表 / 订单详情</p>
...
<p>2、流程进度</p>
<p>以时间轴形式展示订单处理进度，包含以下节点：提交申请、系统派发工单、工单流转中、服务交付完成、服务评价。当前所处节点高亮显示，已通过节点标记为完成，未到达节点标记为待处理。</p>
<p>3、操作-关闭抽屉</p>
<p>点击抽屉右上角【关闭按钮】或遮罩层，关闭详情抽屉，返回服务开通列表页。</p>

<h3 id="prd-3.2.3.3">3.2.3.3 质量评价管理</h3>
<p><strong>入口页面：</strong>订单管理 / 服务开通 / 质量评价管理</p>
<p><strong>页面描述：</strong>查看平台服务的评价汇总与用户评分明细，支持回复用户评分和进行平台评分。</p>

<h3 id="prd-3.2.3.3.1">3.2.3.3.1 评价汇总视图</h3>
<p><strong>模块描述：</strong>质量评价管理 / 评价汇总视图</p>
<p><strong>功能描述：</strong>按服务维度汇总展示用户评分数据，包括四个评分维度的平均值、用户评分和平台评分，支持按服务名称和服务类型筛选，可查看评价明细和进行平台评分。</p>
<p><strong>优先级：</strong>P2</p>
<p><strong>输入/前置条件：</strong>进入页面自动加载评价汇总数据。</p>
<p><strong>详细设计：</strong></p>
<p>1、筛选区域</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<tr><td>平均稳定性</td><td></td><td>展示数值（保留1位小数），大于等于4.0显示绿色，低于阈值显示红色，为空时显示"--"</td></tr>
<tr><td>平均响应时效</td><td></td><td>展示数值（保留1位小数），大于等于4.5显示绿色，大于等于阈值显示橙色，低于阈值显示红色，为空时显示"--"</td></tr>
<tr><td>平均业务适配性</td><td></td><td>展示数值（保留1位小数），大于等于4.0显示绿色，低于阈值显示红色，为空时显示"--"</td></tr>
...
<table>
<tr><th style="white-space:nowrap">状态名称</th><th style="white-space:nowrap">状态代码</th><th>状态对应操作</th></tr>
<tr><td>--</td><td></td><td>查看明细、平台评分</td></tr>
</table>

<h3 id="prd-3.2.3.3.2">3.2.3.3.2 评价明细视图</h3>
<p><strong>模块描述：</strong>质量评价管理 / 评价明细视图</p>
<p><strong>功能描述：</strong>查看某个服务下的用户评分明细列表，支持按评分和状态筛选，可对评价进行回复。</p>
<p><strong>优先级：</strong>P2</p>
<p><strong>输入/前置条件：</strong>在汇总视图中点击【查看明细-按钮】进入，顶部显示当前服务名称和ID。</p>
<p><strong>详细设计：</strong></p>
<p>1、页面头部</p>
<p>显示【返回-按钮】，点击返回汇总视图；右侧显示当前服务名称和服务ID。支持通过 ColumnSettings 控制列显隐。</p>
<p>2、筛选区域</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>评分</td><td></td><td>枚举：5星、4星、3星及以下，默认不选中</td></tr>
...
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>评分维度</td><td></td><td>以"准确性、稳定性、响应时效、业务适配性"四个维度横向排列展示各维度分数，颜色标识：大于等于4分显示绿色，大于等于3分显示橙色，低于3分显示红色，为空时显示"--"</td></tr>
<tr><td>四维均分</td><td></td><td>展示该用户四个维度的算数平均分 = (准确性 + 稳定性 + 响应时效 + 业务适配性) / 4（保留1位小数），颜色标识同评分维度，鼠标悬停提示"准确性、稳定性、响应时效、业务适配性的平均分值"，为空时显示"--"</td></tr>
...
<h3 id="prd-3.2.3.3.3">3.2.3.3.3 回复评价</h3>
<p><strong>模块描述：</strong>质量评价管理 / 评价明细 / 回复评价弹窗</p>
<p><strong>功能描述：</strong>对用户评分进行回复。</p>
<p><strong>优先级：</strong>P2</p>
<p><strong>输入/前置条件：</strong>在评价明细视图中，仅状态为"待回复"的评价展示【回复-按钮】，点击打开回复弹窗。</p>
<p><strong>详细设计：</strong></p>
<p>1、表单字段</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
...
<h3 id="prd-3.2.3.3.4">3.2.3.3.4 平台评分</h3>
<p><strong>模块描述：</strong>质量评价管理 / 评价汇总 / 平台评分弹窗</p>
<p><strong>功能描述：</strong>平台管理员对服务进行综合评分和评价。</p>
<p><strong>优先级：</strong>P2</p>
<p><strong>输入/前置条件：</strong>在评价汇总视图中，点击【平台评分-按钮】打开弹窗。</p>
<p><strong>详细设计：</strong></p>
<p>1、表单字段</p>
<table>
<tr><th style="white-space:nowrap">字段名称</th><th style="white-space:nowrap">字段代码</th><th>字段逻辑与交互说明</th></tr>
<tr><td>综合评价</td><td></td><td>星级评分组件，点击选择1-5星，右侧同步显示当前选中星数</td></tr>
...
<p style="font-style:italic; color:#999">Tip：字段为空：请输入平台评分内容</p>
<p>3）若网络异常/超时/宕机，进行消息提示，停留当前页面</p>
...
<tr><td>需求描述</td><td></td><td>超出2行显示省略号，鼠标悬停展示全部内容（Tooltip），为空时显示"--"</td></tr>
<tr><td>申请机构/申请人</td><td></td><td>展示机构名称和申请人，为空时显示"--"</td></tr>
...
const routePrdMap = {
  ...
  '/portal/service/component':           { anchor: 'prd-3.2.1.2', pageName: '能力组件管理' },
  '/portal/service/componentDetail':     { anchor: 'prd-3.2.1.2.4', pageName: '组件详情' },
  '/portal/service/serviceCatalog':      { anchor: 'prd-3.2.1.3', pageName: '基础服务管理' },
  '/portal/service/serviceCatalogDetail':{ anchor: 'prd-3.2.1.3.4', pageName: '服务详情' },
  '/portal/service/securityService':          { anchor: 'prd-3.2.1.4', pageName: '安全服务管理' },
  '/portal/service/securityServiceDetail':    { anchor: 'prd-3.2.1.4.4', pageName: '安全服务详情' },
  '/portal/service/securityServiceForm':      { anchor: 'prd-3.2.1.4.2', pageName: '新增安全服务' },
  '/portal/service/digitalAppForm':            { anchor: 'prd-3.2.1.1.2', pageName: '新增数字应用' },
  '/portal/service/componentForm':             { anchor: 'prd-3.2.1.2.2', pageName: '新增能力组件' },
  '/portal/service/serviceCatalogForm':        { anchor: 'prd-3.2.1.3.2', pageName: '新增基础服务' },

  // 3.2.2 服务审核管理
  '/portal/auditCenter/qualificationAudit':       { anchor: 'prd-3.2.2.1', pageName: '机构入驻审核' },
  '/portal/auditCenter/qualificationDetail':      { anchor: 'prd-3.2.2.1.2', pageName: '审核详情' },
  '/portal/auditCenter/digitalAppAudit':          { anchor: 'prd-3.2.2.2', pageName: '数字应用审核' },
  '/portal/auditCenter/digitalAppAuditDetail':    { anchor: 'prd-3.2.2.2.2', pageName: '审核详情' },
  '/portal/auditCenter/componentAudit':           { anchor: 'prd-3.2.2.3', pageName: '能力组件审核' },
  '/portal/auditCenter/componentAuditDetail':     { anchor: 'prd-3.2.2.3.2', pageName: '审核详情' },
  '/portal/auditCenter/basicServiceAudit':        { anchor: 'prd-3.2.2.4', pageName: '基础服务审核' },
  '/portal/auditCenter/basicServiceAuditDetail':  { anchor: 'prd-3.2.2.4.2', pageName: '审核详情' },
  '/portal/auditCenter/securityServiceAudit':      { anchor: 'prd-3.2.2.5', pageName: '安全服务审核' },

  // 3.2.3 服务开通管理
  '/portal/order/list':        { anchor: 'prd-3.2.3',   pageName: '服务开通管理' },
  '/portal/order/detail':      { anchor: 'prd-3.2.3.2',   pageName: '订单详情' },
  '/portal/order/review':      { anchor: 'prd-3.2.3.3',   pageName: '质量评价管理' },
  '/workorder/order/list':     { anchor: 'prd-3.2.3',   pageName: '服务管理' },
  '/workorder/order/detail':   { anchor: 'prd-3.2.3.2',   pageName: '订单详情' },
